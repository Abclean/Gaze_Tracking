...
# Store per-image direction counts
...
# === 1. Bar Chart of Total Directions ===
...
plt.pie(direction_counts.values(), labels=direction_counts.keys(), autopct='%1.1f%%', colors=['blue', 'green', 'orange'])
...
bottoms = [left + center for left, center in zip(left_counts, center_counts)]
